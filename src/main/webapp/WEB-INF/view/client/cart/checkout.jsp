                    ...
                    <div class="container-fluid pt-5 mt-5">
                        <div class="container pt-5">
                            <ol class="breadcrumb mb-4">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-decoration-none" href="/cart">Chi tiết giỏ hàng</a>
                                </li>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:choose>
                                            <c:when test="${cartDetails.isEmpty()}">
                                                <tr>
                                                    <td colspan="6">
                                                        <p class="my-2">Không có sản phẩm trong giỏ hàng</p>
                                                    </td>
                                                </tr>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <div class="row mt-5 g-4">
                                            <div class="col-md-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    <label class="my-3">Tên người nhận <sup>*</sup></label>
                                                    <input name="receiverName" class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label class="my-3">Địa chỉ <sup>*</sup></label>
                                                    <input name="receiverAddress" class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label class="my-3">Số điện thoại <sup>*</sup></label>
                                            ...
                                            <div class="col-sm-8 col-md-7 col-lg-6 col-xl-6">
                                                <div class="bg-light rounded">
                                                    <div class="p-4">
                                                        <h1 class="display-6 mb-4 fw-normal">Thông tin thanh toán</h1>
